    ...
    const rules: TriggerRule[] = [
        {
            ...
            condition: (m: string[]) => !m.includes('Clientes') && !m.includes('Cotizaciones'),
            title: 'Sugerencia',
        ...
        },
        {
            ...
            condition: (m: string[]) => !m.includes('Clientes'),
            title: 'Sugerencia',
        ...
        },
        {
            ...
            condition: (m: string[]) => !m.includes('Prospectos') && !m.includes('Clientes'),
            title: 'Sugerencia',
        ...
        },
        {
            ...
            condition: (m: string[]) => !m.includes('Finanzas'),
            title: 'Requisito',
        ...
        },
        {
            ...
            condition: (m: string[]) => !m.includes('Compras'),
            title: 'Sugerencia',
