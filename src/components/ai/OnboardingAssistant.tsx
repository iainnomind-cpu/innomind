...
// Group steps by module for the progress pills
                ...
                <>
                    ...
                    {minimized && (
                        <motion.button
                            ...
                            className="fixed bottom-6 right-6 z-[110] flex items-center gap-2.5 bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-4 py-2.5 rounded-full shadow-lg hover:shadow-xl transition-shadow"
                            style={{ boxShadow: '0 4px 24px 0 rgba(37,99,235,0.35)' }}
                        >
