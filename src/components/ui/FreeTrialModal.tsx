...
export default function FreeTrialModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            {/* Modal Container */}
            <div className={`relative w-full bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col h-[85vh] transition-all duration-300 ${step === 3 ? 'max-w-4xl' : 'max-w-2xl'}`}>
                ...
                {/* Body */}
                <div className="px-6 py-2 md:px-8 overflow-y-auto flex-grow">
                    {step === 1 && (
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all appearance-none cursor-pointer"
                                        >
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-in slide-in-from-right-4 duration-300 pb-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                {/* Card A: CRM-ERP */}
                                <div
                                    className={`relative p-4 rounded-xl border-2 transition-all cursor-pointer group ${selectedMainModule === 'crm-erp' ? 'border-blue-600 bg-blue-50/50 dark:bg-blue-900/20' : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-blue-400'}`}
                                ...
                                >
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-1">CRM-ERP UNIFICADO</h3>
                                    <p className="text-xs text-slate-600 dark:text-slate-400 mb-3 h-8">Automatiza ventas, finanzas y operaciones en un solo lugar</p>
                                ...
                                <div
                                    className={`relative p-4 rounded-xl border-2 transition-all cursor-pointer group ${selectedMainModule === 'project-tracker' ? 'border-purple-600 bg-purple-50/50 dark:bg-purple-900/20' : 'border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-purple-400'}`}
                                ...
                                >
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-1">PROJECT TRACKER</h3>
                                    <p className="text-xs text-slate-600 dark:text-slate-400 mb-3 h-8">Gestiona proyectos y equipos con metodologías ágiles</p>
                            ...
                            {selectedMainModule === 'crm-erp' && (
                                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 animate-in fade-in slide-in-from-top-4 duration-300">
                                    <div className="mb-4">
                                        <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1">Construye tu Sistema a Medida</h3>
                                        <p className="text-xs text-slate-600 dark:text-slate-400">¿Qué áreas de tu negocio quieres automatizar? Selecciona los módulos que necesitas.</p>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                                        />
                ...
                {/* Footer */}
                <div className="px-6 py-2 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30 shrink-0 mt-auto">
                    <div className="flex flex-col gap-3">
                        <div className="flex gap-3">
                            {step > 1 && (
                                <button
                                    className="px-6 py-3 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-bold hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                            ...
                            <button
                                className={`flex-1 bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition-all shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 ${(step === 1 && !isStep1Valid) || (step === 3 && !isStep3Valid)
    ...
    return (
        <div className="space-y-2">
            ...
            <input
                ...
                onChange={onChange}
                onBlur={onBlur}
                className={`w-full px-4 py-2 rounded-lg border bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder:text-slate-400 outline-none transition-all ${error
